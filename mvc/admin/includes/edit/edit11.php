...
include "../database.php" ;
	...
	$script = "SELECT id, image, title, status, descriptions FROM post_manager WHERE id=11" ;
...
<body>
  ...
  <div class="main_part">
	...
	<div class='button'>
		<a href="../../../postlist/p11.php" class="w3-btn w3-black">
	...
	<div class="edit-table">
		...
		<div class="title" >
		  <form action="edit11.php" method="post" enctype="multipart/form-data">
			<label> <b>Title </label>
