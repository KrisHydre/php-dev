...
include "../database.php" ;
	...
	$script = "SELECT id, image, title, status, descriptions FROM post_manager WHERE id=9" ;
...
<body>
  ...
  <div class="main_part">
	...
	<div class='button'>
		<a href="../../../postlist/p9.php" class="w3-btn w3-black">
	...
	<div class="edit-table">
		...
		<div class="title" >
		  <form action="edit9.php" method="post" enctype="multipart/form-data">
			<label> <b>Title </label>
